            ...
            while(processNextCommand)
            {
                ...
                while (!pid)
                {
                    ...
                    while (tt != NULL)
                    {
                        ...
                        // condition
                        if(!strcmp(tt->word, "&&") || !strcmp(tt->word, "||") || !strcmp(tt->word, ";"))
                        {
                            tt = tt->next;
                            break;
                        }
                ...
                else
                {
                    ...
                    if(condition == 1)
                        ...
                        if (status)
                            processNextCommand = 1;
                        else processNextCommand = 0;
                    else if (condition == 3)
                        if (status)
                            processNextCommand = 0;
                        else processNextCommand = 1;
                    else
                        processNextCommand = 0;
                }
            }
